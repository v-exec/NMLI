...
<br>
<br>
I know, you must be shocked: a large explosion just happened, things are looking awfully frightful, and now a little piece of plastic is writing on your screen. I assure you, this is at least <i>somewhat normal</i>, and you’ll be <i>fine</i>. I’ve accessed the camera on your little computer here so we can have a conversation face to face, as you humans would!
<br>
<br>
...
<br>
<br>
Oh,<i> right</i>, I suppose you were more curious about the explosion. To tell you the truth, I’ve no clue what happened. But I can reckon a guess, if you care for speculation.
`);
...
decryptions.push(`
a=k b=f c=x d=n e=c f=i g=a h=t i=z j=j k=l l=m m=h n=d o=u p=y q=v r=p s=e t=g u=q v=o w=r x=w y=b z=s
`);